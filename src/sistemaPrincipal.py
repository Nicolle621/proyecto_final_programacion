...
class SistemaTransporte:
    ...
    def iniciarViaje(self):
        ...
        # ✅ CORREGIDO: Asignar el viaje activo al bus
        self.buses[idBus].viajeActivo = idViaje

        # Asignamos bus y conductor a la ruta
    ...
    def registrarIngreso(self):
        ...
        # ✅ CORREGIDO: Verificar que el bus tenga un viaje activo
    ...
    def cerrarViaje(self):
        ...
        # ✅ CORREGIDO: Limpiar el viaje activo del bus
        bus_id = reporte["Bus"]
